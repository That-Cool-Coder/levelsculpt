...
EDITOR_ZOOM_SPEED = 1.001

SELECTION_BORDER_THICKNESS = 3
SELECTION_BORDER_GRAB_WIDTH = 5
...
DEFAULT_EDITOR_SIDEBAR_SIZE = Vector2(200, DEFAULT_EDITOR_SIZE.x)
EDITOR_SIDEBAR_BACKGROUND = 'white'

DEFAULT_EDITOR_SETTINGS = {
    'blockSet' : DEFAULT_BLOCKSET,
    'blockType' : DEFAULT_BLOCKSET.getBlockType('platform'),
    'snapToGrid' : False,
    'gridSize' : 50
}